...
export default function OnlinePreparationWorkspace({ userId, section, onSectionChange, onPaperCreated, onOpenJournalCenter }: Props) {
  ...
  return <div className="online-preparation-shell">
    {error
      ...
      : <PreparationWorkspaceSuite section={section} onSectionChange={onSectionChange} onOpenJournalCenter={onOpenJournalCenter} snapshot={snapshot} loading={loading} onSaveJournal={saveJournal} onDeleteJournal={deleteJournal} onSaveTopic={saveTopic} onDeleteTopic={deleteTopic} onSaveDraft={saveDraft} onDeleteDraft={deleteDraft} onPromoteDraft={promoteDraft} onLookupJournalRanks={lookupJournalRanks} onDraftFigureCountChange={syncDraftFigureCount} />}
  </div>
}
