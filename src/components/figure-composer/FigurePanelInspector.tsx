      ...
      <details className="figure-composer__compact-details figure-composer__panel-label-details">
        ...
        <div className="figure-composer__details-body">
          ...
          <div className="figure-composer__field-grid two">
            <label>样式<select value={panel.label.style} onChange={event => onPatch(panel.id, { label: { ...panel.label, style: event.target.value as FigurePanel['label']['style'] } })}><option value="parena">(a), (b), (c)</option><option value="a">a, b, c</option><option value="parenA">(A), (B), (C)</option><option value="A">A, B, C</option></select></label>
