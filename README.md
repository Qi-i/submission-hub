...
| 🔄 流程衔接 | 选题可一键建立草稿；确认正式投出后自动生成已投稿记录、Submitted 时间线并回写草稿状态 |
| 📌 投稿状态 | 准备中、已投稿、审稿中、修回中、已接收、被拒、已撤稿 |
| 🏷️ 审稿子状态 | With Editor、Out for Review、Decision Pending 等子状态作为主状态下方的次级状态显示 |
...
| 🖼️ 文档截图 | Update Documentation Screenshots | 手动运行 | 使用虚构数据更新 README 截图 |
